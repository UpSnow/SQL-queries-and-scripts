...
Insert Into Cliente (codigo, nome, tipo, contato, cargo, endereco, cep, fone) Values (1, 'Maria Helena Ferreira', 'PF', 'Helena', 'Medica', 'R. das Flores, 33, Manaira', '58.045-002', '3225-6987')
Insert Into Cliente (codigo, nome, tipo, contato, cargo, endereco, cep, fone) Values (2, 'João Paulo Correia', 'PF', 'Paulo', 'Advogado', 'R. das Acacias, 920, Bessa', '58.037-255', '3245-8999')
Insert Into Cliente (codigo, nome, tipo, contato, cargo, endereco, cep, fone) Values (3, 'Larissa Maia', 'PF', 'Larissa', 'Estudante', 'R. das Flores, 95, Manaira', '58.045-002', '3227-9622')
Insert Into Cliente (codigo, nome, tipo, contato, cargo, endereco, cep, fone) Values (4, 'Marcos Andrade', 'PF', 'Marcos', 'Analista de Sistemas', 'Av. Juruá, 95', '58.000-00', '3338-2100')
Insert Into Cliente (codigo, nome, tipo, endereco, cep, fone) Values (5, 'LT Comércio', 'PJ', 'Av. Ingá, 97', '56.000-00', '3256-9981')
Insert Into Cliente (codigo, nome, tipo, endereco, cep, fone) Values (6, 'JR Representações', 'PJ', 'Av. Maracatu, 665', '21.654-00', '5841-9871')
Insert Into Cliente (codigo, nome, tipo, endereco, cep, fone) Values (7, 'Cea Parafusos', 'PJ', 'Av. Maracatu, 665', '00.222-00', '5777-9871')
Insert Into Cliente (codigo, nome, tipo, contato, cargo, endereco, cep, fone) Values (8, 'Edna Passos', 'PF', 'Edna', 'Medica', 'R. das Flores, 33, Manaira', '58.045-002', '3225-6987')

--select * from Cliente


Insert Into Produto Values (1, 'Toalhas Artex', 'Conjunto de Toalhas', 'Toalha Kings', 210, 125, 50, 25, 'N')
Insert Into Produto Values (2, 'Iogurte Nestle', 'Conjunto com 6 potes de Iogurte', 'Danoninho', 3.2, 1.35, 200, 150, 'N')
Insert Into Produto Values (3, 'Abajur Alist', 'Abajur de vidro e cristal', 'Abajur', 450, 290, 12, 6, 'S')
Insert Into Produto Values (4, 'TV LCD', 'TV LCD 42 polegadas', 'TV LCD', 2900, 1650, 12, 9, 'N')
Insert Into Produto Values (5, 'Liquidificador', 'Liquidificador Arno 6 posições', 'Liquidificador Dmais', 158, 112, 150, 100, 'S')
Insert Into Produto Values (6, 'Computador Positivo', 'Computador Pentium IV', 'Positivo PIV', 1980, 1600, 24, 13, 'D')
Insert Into Produto Values (7, 'Pizza Sadia', 'Pizza tamanho médio Sadia', 'Pizza Sadia', 12.9, 8.1, 541, 200, 'N')
INSERT INTO Produto (codigo, nome, descricao, apresent, venda, custo, quantest, estmin, situacao) VALUES (8, 'Leite Integral', 'Leite integral 1L', '1 Litro', 2.99, 1.99, 500, 50, 'N');
INSERT INTO Produto (codigo, nome, descricao, apresent, venda, custo, quantest, estmin, situacao) VALUES (9, 'Toalha de Banho', 'Toalha de banho de algodão', 'Banho', 19.99, 12.99, 100, 10, 'S');
INSERT INTO Produto (codigo, nome, descricao, apresent, venda, custo, quantest, estmin, situacao) VALUES (10, 'Arroz', 'Arroz Tipo 1', '1 kg', 4.49, 3.29, 300, 30, 'D');
INSERT INTO Produto (codigo, nome, descricao, apresent, venda, custo, quantest, estmin, situacao) VALUES (11, 'Cama de Casal', 'Cama de casal em madeira', 'Casal', 599.99, 399.99, 50, 5, 'N');
INSERT INTO Produto (codigo, nome, descricao, apresent, venda, custo, quantest, estmin, situacao) VALUES (12, 'Quadro Abstrato', 'Quadro de arte abstrata', 'Pequeno', 49.99, 29.99, 200, 20, 'S');
INSERT INTO Produto (codigo, nome, descricao, apresent, venda, custo, quantest, estmin, situacao) VALUES (13, 'Batedeira', 'Batedeira com jarra de vidro', '600W', 120.99, 99.99, 80, 8, 'D');

--select * from produto

Insert Into Funcionario (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, bairro, salario ) Values (1, 'João da Silva', 'M', 'S', '2541399', '04598722354', '1978-02-05', '2005-06-09', 'R. Uire, 98', 'Tambaú', 2500)
Insert Into Funcionario (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, bairro, salario ) Values (2, 'Maria de Souza', 'F', 'C', '0145687', '24598711200', '1970-01-01', '2000-09-08', 'R. Umbuzeiro, 12', 'Manaíra', 3000)
Insert Into Funcionario (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, bairro, salario ) Values (3, 'Luiza Costa', 'F', 'C', '2185411', '36574100296', '1980-04-04', '1998-05-01', 'A. Esperança, 91', 'Bessa', 9500)
Insert Into Funcionario (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, bairro, salario, email ) Values (4, 'Francisco da Silva', 'M', 'D', '0584132', '01487933587', '1970-06-03', '2002-08-05', 'Av. Fagundes, 05', 'Mangabeira', 3900, 'franc@uol.com.br')
Insert Into Funcionario (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, bairro, salario, email ) Values (5, 'Carla Tavares', 'F', 'C', '2987411', '36544800298', '1969-01-08', '1992-03-01', 'R. Uire, 154', 'Tambaú', 2900, 'carla@gmail.com')
INSERT INTO FUNCIONARIO (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, complemento, bairro, salario, email, obs) VALUES (6, 'Ana Silva', 'F', 'S', '1234567', '98765432109', '1990-08-15', '2020-02-10', '123 Rua Principal', 'Apto 303', 'Centro', 5500.00, 'ana.silva@email.com', 'Funcionária exemplar');
INSERT INTO FUNCIONARIO (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, complemento, bairro, salario, email, obs) VALUES (7, 'João Santos', 'M', 'C', '2345678', '12345678901', '1985-03-20', '2019-05-05', '456 Avenida Principal', 'Apto 102', 'Centro', 6000.00, 'joao.santos@email.com', 'Supervisor de Marketing');
INSERT INTO FUNCIONARIO (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, complemento, bairro, cep, fone, celular, salario, email, obs) VALUES (8, 'Maria Silva', 'F', 'S', '3456789', '23456789012', '1988-11-25', '2018-09-15', '789 Rua Secundária', NULL, 'Centro', NULL, NULL, NULL, 4800.00, 'maria.silva@email.com', 'Gerente de Administração');
INSERT INTO FUNCIONARIO (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, complemento, bairro, cep, fone, celular, salario, email, obs) VALUES (9, 'Pedro Santos', 'M', 'C', '4567890', '34567890123', '1992-06-12', '2021-03-30', '987 Avenida Secundária', NULL, 'Centro', NULL, NULL, NULL, 5200.00, 'pedro.santos@email.com', 'Supervisor de Segurança');
INSERT INTO FUNCIONARIO (codigo, nome, sexo, estcivil, rg, cpf, datanasc, dataadm, endereco, complemento, bairro, cep, fone, celular, salario, email, obs) VALUES (10, 'Sofia Rodrigues', 'F', 'S', '6789012', '56789012345', '1995-12-18', '2019-10-25', '123 Rua do Comércio', 'Sala 302', 'Centro', '12345', NULL, NULL, 5100.00, 'sofia.rodrigues@email.com', 'Coordenadora de Vendas');
